...
The version string is an extension to semver, the format looks like `11.2.1-2.1`.
...
total 470320
-rw-rw-rw- 1 ilg ilg 234639449 May 15 15:35 xpack-arm-none-eabi-gcc-11.2.1-2.1-linux-x64.tar.gz
-rw-rw-rw- 1 ilg ilg       118 May 15 15:35 xpack-arm-none-eabi-gcc-11.2.1-2.1-linux-x64.tar.gz.sha
-rw-rw-rw- 1 ilg ilg 246953724 May 15 15:54 xpack-arm-none-eabi-gcc-11.2.1-2.1-win32-x64.zip
-rw-rw-rw- 1 ilg ilg       115 May 15 15:54 xpack-arm-none-eabi-gcc-11.2.1-2.1-win32-x64.zip.sha
```
...
$ ls -l ~/Work/arm-none-eabi-gcc-*/deploy
total 227572
-rw-rw-rw- 1 ilg ilg 233025589 May 15 23:28 xpack-arm-none-eabi-gcc-11.2.1-2.1-linux-arm64.tar.gz
-rw-rw-rw- 1 ilg ilg       120 May 15 23:28 xpack-arm-none-eabi-gcc-11.2.1-2.1-linux-arm64.tar.gz.sha
```
...
$ ls -l ~/Work/arm-none-eabi-gcc-*/deploy
total 221220
-rw-rw-rw- 1 ilg ilg 226520982 May 15 23:57 xpack-arm-none-eabi-gcc-11.2.1-2.1-linux-arm.tar.gz
-rw-rw-rw- 1 ilg ilg       118 May 15 23:57 xpack-arm-none-eabi-gcc-11.2.1-2.1-linux-arm.tar.gz.sha
```
...
$ ls -l ~/Work/arm-none-eabi-gcc-*/deploy
total 459272
-rw-r--r--  1 ilg  staff  231906304 May 15 22:10 xpack-arm-none-eabi-gcc-11.2.1-2.1-darwin-x64.tar.gz
-rw-r--r--  1 ilg  staff        119 May 15 22:10 xpack-arm-none-eabi-gcc-11.2.1-2.1-darwin-x64.tar.gz.sha
```
...
$ ls -l ~/Work/arm-none-eabi-gcc-*/deploy
total 460424
-rw-r--r--  1 ilg  staff  231236234 May 15 15:10 xpack-arm-none-eabi-gcc-11.2.1-2.1-darwin-arm64.tar.gz
-rw-r--r--  1 ilg  staff        121 May 15 15:10 xpack-arm-none-eabi-gcc-11.2.1-2.1-darwin-arm64.tar.gz.sha
```
...
```console
$ .../Downloads/xpack-arm-none-eabi-gcc-11.2.1-2.1/bin/arm-none-eabi-gcc --version
...
```console
$ tree -L 2 /Users/ilg/Library/xPacks/\@xpack-dev-tools/arm-none-eabi-gcc/11.2.1-2.1/.content/
/Users/ilg/Library/xPacks/\@xpack-dev-tools/arm-none-eabi-gcc/11.2.1-2.1/.content/
├── README.md
├── arm-none-eabi
│   ├── bin
│   ├── include
