...
file; the format is `11.2.1-1.3`. The fourth number is the Arm release
...
and fix them; assign them to a milestone (like `11.2.1-1.3`).
...
Update both full 5 numbers (`11.2.1-1.3`) and short 3 numbers (`11.2.1`)
versions in:
...
- add a new entry like _- v11.2.1-1.3 prepared_
- commit with a message like _prepare v11.2.1-1.3_
...
- in `CHANGELOG.md`, add the release date and a message like _- v11.2.1-1.3 released_
...
tagged like **v11.2.1-1.3** (mind the dash in the middle!) and
named like **xPack GNU Arm Embedded GCC v11.2.1-1.3** (mind the dash),
...
- commit the `develop` branch of `xpack/web-jekyll` GitHub repo;
  use a message like **xPack GNU Arm Embedded GCC v11.2.1-1.3 released**
- push to GitHub
...
- commit all changes, use a message like
  `package.json: update urls for 11.2.1-1.3 release` (without `v`)

## Publish on the npmjs.com server

- select the `xpack-develop` branch
- check the latest commits `npm run git-log`
- update `CHANGELOG.md`, add a line like _- v11.2.1-1.3.1 published on npmjs.com_
- commit with a message like _CHANGELOG: publish npm v11.2.1-1.3.1_
- `npm pack` and check the content of the archive, which should list
  only the `package.json`, the `README.md`, `LICENSE` and `CHANGELOG.md`;
  possibly adjust `.npmignore`
- `npm version 11.2.1-1.3.1`; the first 5 numbers are the same as the
...
- `npm dist-tag add @xpack-dev-tools/arm-none-eabi-gcc@11.2.1-1.3.1 latest`
- `npm dist-tag ls @xpack-dev-tools/arm-none-eabi-gcc`

In case the previous version is not functional and needs to be unpublished:

- `npm unpublish @xpack-dev-tools/arm-none-eabi-gcc@11.2.1-1.3.X`
...
- paste the release name like **xPack GNU Arm Embedded GCC v11.2.1-1.3 released**
...
- title: xPack GNU Arm Embedded GCC v11.2.1-1.3 released
- content:
  ...
  - The latest release is [11.2.1-1.3]() following Arm release from February 15, 2022 (version 11.2-2022.02).
