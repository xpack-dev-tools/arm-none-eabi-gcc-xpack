...
named like **xPack GNU Arm Embedded GCC v11.2.1-1.2** (mind the dash),
...
- commit the `develop` branch of `xpack/web-jekyll` GitHub repo;
  use a message like **xPack GNU Arm Embedded GCC v11.2.1-1.2 released**
- push to GitHub
...
- `npm unpublish @xpack-dev-tools/arm-none-eabi-gcc@11.2.1-1.2.X`
...
- paste the release name like **xPack GNU Arm Embedded GCC v11.2.1-1.2 released**
...
- content:
  ...
  - The latest release is [11.2.1-1.2]() following Arm release from February 15, 2022 (version 11.2-2022.02).
