...
Determine the GCC version (like `10.3.1`) and update the `scripts/VERSION`
file; the format is `10.3.1-2.2`. The fourth number is the Arm release
...
and fix them; assign them to a milestone (like `10.3.1-2.2`).
...
- add a new entry like _- v10.3.1-2.2 prepared_
- commit with a message like _prepare v10.3.1-2.2_
...
- in `CHANGELOG.md`, add the release date and a message like _- v10.3.1-2.2 released_
- commit and push the `xpack-develop` branch
- run the xPack action `trigger-workflow-publish-release`

The result is a
[draft pre-release](https://github.com/xpack-dev-tools/arm-none-eabi-gcc-xpack/releases/)
tagged like **v10.3.1-2.2** (mind the dash in the middle!) and
named like **xPack GNU Arm Embedded GCC v10.3.1-2.2** (mind the dash),
...
- commit the `develop` branch of `xpack/web-jekyll` GitHub repo;
  use a message like **xPack GNU Arm Embedded GCC v10.3.1-2.2 released**
- push to GitHub
...
- commit all changes, use a message like
  `package.json: update urls for 10.3.1-2.2 release` (without `v`)

## Publish on the npmjs.com server

- select the `xpack-develop` branch
- check the latest commits `npm run git-log`
- update `CHANGELOG.md`, add a line like _- v10.3.1-2.2.1 published on npmjs.com_
- commit with a message like _CHANGELOG: publish npm v10.3.1-2.2.1_
- `npm pack` and check the content of the archive, which should list
  only the `package.json`, the `README.md`, `LICENSE` and `CHANGELOG.md`;
  possibly adjust `.npmignore`
- `npm version 10.3.1-2.2.1`; the first 5 numbers are the same as the
...
- `npm dist-tag add @xpack-dev-tools/arm-none-eabi-gcc@10.3.1-2.2.1 latest`
- `npm dist-tag ls @xpack-dev-tools/arm-none-eabi-gcc`

In case the previous version is not functional and needs to be unpublished:

- `npm unpublish @xpack-dev-tools/arm-none-eabi-gcc@10.3.1-2.2.X`
...
- paste the release name like **xPack GNU Arm Embedded GCC v10.3.1-2.2 released**
...
- content:
  ...
  - The latest release is [10.3.1-2.2]() following Arm release from October 21, 2021 (version 10.3-2021.10).
