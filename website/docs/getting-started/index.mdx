...
**xPack GNU Arm Embedded GCC** is an open source project hosted on GitHub as
...
[build scripts](https://github.com/xpack-dev-tools/arm-none-eabi-gcc-xpack/tree/xpack/scripts).
