...
- **Push** the `website` branch to GitHub
  ...
  the [website](https://xpack-dev-tools.github.io/arm-none-eabi-gcc-xpack/).
  :::
- Check out the `xpack-development` branch
- **Wait** for the publication to complete 
- check [GitHub Pages](https://github.com/xpack-dev-tools/arm-none-eabi-gcc-xpack/actions/workflows/publish-github-pages.yml) workflow
- **Refresh** the web page
- The new release blog post is available
at https://xpack-dev-tools.github.io/arm-none-eabi-gcc-xpack/blog/
...
Verify the result at https://xpack-dev-tools.github.io/arm-none-eabi-gcc-xpack/.
