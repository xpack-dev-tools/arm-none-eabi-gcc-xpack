...
title: How to make new xPack GNU Arm Embedded GCC releases
...
```sh
xpm run clear-all-project-builds -C ~/Work/xpack-dev-tools/arm-none-eabi-gcc-xpack.git/build-assets
```
...
named like **xPack GNU Arm Embedded GCC v{customField('upstreamVersion')}-{customField('xpackSubversion')}** (mind the dash),
...
npm dist-tag add @xpack-dev-tools/arm-none-eabi-gcc@${customField('upstreamVersion')}-${customField('xpackSubversion')}.${customField('npmSubversion')} latest
npm dist-tag ls @xpack-dev-tools/arm-none-eabi-gcc
`} </CodeBlock>
...
- paste the release name like _**xPack GNU Arm Embedded GCC v{customField('upstreamVersion')}-{customField('xpackSubversion')} released**_
