...
the **[Update the version specific code](http://localhost:3000/arm-none-eabi-gcc-xpack/docs/maintainer/#update-the-version-specific-code)** section.
...
```sh
rm -f ~/Work/xpack-dev-tools/arm-none-eabi-gcc-xpack.git/build-assets/package-lock.json
git -C ~/Work/xpack-dev-tools/arm-none-eabi-gcc-xpack.git pull
...
this will add a file in the `website/blog` folder:
  ```sh
  xpm run generate-website-blog-post -C ~/Work/xpack-dev-tools/arm-none-eabi-gcc-xpack.git/build-assets
  ```
...
[![NPM Version](https://img.shields.io/npm/v/%40xpack-dev-tools%2Farm-none-eabi-gcc?color=green)](https://www.npmjs.com/package/@xpack-dev-tools/arm-none-eabi-gcc/)
[![NPM Downloads](https://img.shields.io/npm/dm/%40xpack-dev-tools%2Farm-none-eabi-gcc)](https://www.npmjs.com/package/@xpack-dev-tools/arm-none-eabi-gcc/)
  - all releases [![NPM Downloads](https://img.shields.io/npm/dt/%40xpack-dev-tools%2Farm-none-eabi-gcc)](https://www.npmjs.com/package/@xpack-dev-tools/arm-none-eabi-gcc/)
