...
The **xPack GNU Arm Embedded GCC** may be installed automatically, utilising the `xpm` command
(the recommended method), or manually, by downloading and unpacking one of the
platform-specific archives.

## Automated installation

The easiest (and recommended) method to install xPack GNU Arm Embedded GCC
...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/@xpack-dev-tools/arm-none-eabi-gcc/15.2.1-1.1.1/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/@xpack-dev-tools/arm-none-eabi-gcc/15.2.1-1.1.1/.content/bin:$PATH
`} </CodeBlock>
...
<ul>
<li><code>xpack-arm-none-eabi-gcc-15.2.1-1.1-win32-x64.zip</code></li>
</ul>
...
example <code>C:\\Users\\ilg\\AppData\\Roaming\\xPacks\\arm-none-eabi-gcc\\xpack-arm-none-eabi-gcc-15.2.1-1.1</code>.
...
<ul>
<li><code>xpack-arm-none-eabi-gcc-15.2.1-1.1-darwin-x64.tar.gz</code></li>
<li><code>xpack-arm-none-eabi-gcc-15.2.1-1.1-darwin-arm64.tar.gz</code></li>
</ul>
...
example <code>/Users/ilg/Library/xPacks/arm-none-eabi-gcc/xpack-arm-none-eabi-gcc-15.2.1-1.1</code>:

<CodeBlock language="console"> {
`mkdir -p ~/Library/xPacks/arm-none-eabi-gcc
cd ~/Library/xPacks/arm-none-eabi-gcc

tar xvf ~/Downloads/xpack-arm-none-eabi-gcc-15.2.1-1.1-darwin-x64.tar.gz
chmod -R -w xpack-arm-none-eabi-gcc-15.2.1-1.1
`} </CodeBlock>
...
<ul>
<li><code>xpack-arm-none-eabi-gcc-15.2.1-1.1-linux-x64.tar.gz</code></li>
<li><code>xpack-arm-none-eabi-gcc-15.2.1-1.1-linux-arm64.tar.gz</code></li>
</ul>
...
example <code>/home/ilg/.local/xPacks/arm-none-eabi-gcc/xpack-arm-none-eabi-gcc-15.2.1-1.1</code>:

<CodeBlock language="console"> {
`mkdir -p ~/.local/xPacks/arm-none-eabi-gcc
cd ~/.local/xPacks/arm-none-eabi-gcc

tar xvf ~/Downloads/xpack-arm-none-eabi-gcc-15.2.1-1.1-linux-x64.tar.gz
chmod -R -w xpack-arm-none-eabi-gcc-15.2.1-1.1
`} </CodeBlock>
