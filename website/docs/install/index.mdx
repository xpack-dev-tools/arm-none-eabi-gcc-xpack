...
The easiest (and recommended) way to install GNU Arm Embedded GCC
...
* identify the platform specific archive for the latest available version
  of GNU Arm Embedded GCC, download it into a cache and unpack
...
* create a local symbolic link
  like <code>xpacks/@xpack-dev-tools/arm-none-eabi-gcc</code> pointing to the
...
* add <code>@xpack-dev-tools/arm-none-eabi-gcc</code> to
  `package.json` as a
  development dependency; this associates a specific version of GNU Arm Embedded GCC with
...
it is also possible to install GNU Arm Embedded GCC only globally in
...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/\@pack-dev-tools/arm-none-eabi-gcc /${ customField('upstreamVersion') }-${ customField('xpackSubversion') }.${ customField('npmSubversion') }/.content/bin:$PATH`
} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/\@pack-dev-tools/arm-none-eabi-gcc /${ customField('upstreamVersion') }-${ customField('xpackSubversion') }.${ customField('npmSubversion') }/.content/bin:$PATH`
} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/.local/xPacks/@xpack-dev-tools/arm-none-eabi-gcc /${ customField('upstreamVersion') }-${ customField('xpackSubversion') }.${ customField('npmSubversion') }/.content/bin:$PATH`
} </CodeBlock>
...
* <code>xpack-arm-none-eabi-gcc-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }-win32-x64.zip</code>
...
example <code>C:\\Users\\ilg\\AppData\\Roaming\\xPacks\\arm-none-eabi-gcc\\xpack-arm-none-eabi-gcc-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }</code>.
...
* <code>xpack-arm-none-eabi-gcc-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }-darwin-x64.tar.gz</code>
* <code>xpack-arm-none-eabi-gcc-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }-darwin-arm64.tar.gz</code>
...
example <code>/Users/ilg/Library/xPacks/arm-none-eabi-gcc/xpack-arm-none-eabi-gcc-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }</code>:

<CodeBlock language="console"> {
`mkdir -p ~/Library/xPacks/arm-none-eabi-gcc
cd ~/Library/xPacks/arm-none-eabi-gcc

tar xvf ~/Downloads/xpack-arm-none-eabi-gcc-${ customField('upstreamVersion') }-${ customField('xpackSubversion') }-darwin-x64.tar.gz
chmod -R -w xpack-arm-none-eabi-gcc-${ customField('upstreamVersion') }-${ customField('xpackSubversion') }`
} </CodeBlock>
...
* <code>xpack-arm-none-eabi-gcc-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }-darwin-x64.tar.gz</code>
* <code>xpack-arm-none-eabi-gcc-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }-darwin-arm64.tar.gz</code>
* <code>xpack-arm-none-eabi-gcc-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }-darwin-arm.tar.gz</code>
...
example <code>/home/ilg/.local/xPacks/arm-none-eabi-gcc/xpack-arm-none-eabi-gcc-{ customField('upstreamVersion') }-{ customField('xpackSubversion') }</code>:

<CodeBlock language="console"> {
`mkdir -p ~/.local/xPacks/arm-none-eabi-gcc
cd ~/.local/xPacks/arm-none-eabi-gcc

tar xvf ~/Downloads/xpack-arm-none-eabi-gcc-${ customField('upstreamVersion') }-${ customField('xpackSubversion') }-linux-x64.tar.gz
chmod -R -w xpack-arm-none-eabi-gcc-${ customField('upstreamVersion') }-${ customField('xpackSubversion') }`
} </CodeBlock>
