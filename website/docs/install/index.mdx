...
title: How to install arm-none-eabi-gcc
...
# How to install xPack GNU Arm Embedded GCC
...
[![npm (scoped)](https://img.shields.io/npm/v/%40xpack-dev-tools%2Farm-none-eabi-gcc?label=xpm&color=blue)](https://www.npmjs.com/package/@xpack-dev-tools/arm-none-eabi-gcc/)
![GitHub Downloads (all assets, all releases)](https://img.shields.io/github/downloads/xpack-dev-tools/arm-none-eabi-gcc-xpack/total)
[![npm](https://img.shields.io/npm/dm/%40xpack-dev-tools%2Farm-none-eabi-gcc?label=xpm%20downloads)](https://www.npmjs.com/package/@xpack-dev-tools/arm-none-eabi-gcc/)
...
- <code>xpack-arm-none-eabi-gcc-{customField('xpackVersion')}-win32-x64.zip</code>
...
- <code>xpack-arm-none-eabi-gcc-{customField('xpackVersion')}-darwin-x64.tar.gz</code>- <code>xpack-arm-none-eabi-gcc-{customField('xpackVersion')}-darwin-arm64.tar.gz</code>
...
- <code>xpack-arm-none-eabi-gcc-{customField('xpackVersion')}-linux-x64.tar.gz</code>- <code>xpack-arm-none-eabi-gcc-{customField('xpackVersion')}-linux-arm64.tar.gz</code>- <code>xpack-arm-none-eabi-gcc-{customField('xpackVersion')}-linux-arm.tar.gz</code>
