...
function build_versions()
{
  ...
  then
    ...
    GCC_COMBO_URL="https://developer.arm.com/-/media/Files/downloads/gnu-rm/${GCC_COMBO_VERSION_MAJOR}.${GCC_COMBO_VERSION_MINOR}-${GCC_COMBO_VERSION_YEAR}.${GCC_COMBO_VERSION_MONTH}/${GCC_COMBO_ARCHIVE}"
    ...
    # git://sourceware.org/git/newlib-cygwin.git commit 2a3a03972b35377aef8d3d52d873ac3b8fcc512c    # VERSION from configure, comment in NEWS.
    # PACKAGE_VERSION from newlib/configure, comment in newlib/NEWS.
