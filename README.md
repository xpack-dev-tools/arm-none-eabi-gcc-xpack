...
```console
$ tree -L 2 /Users/ilg/Library/xPacks/\@xpack-dev-tools/arm-none-eabi-gcc/12.3.1-1.2/.content/
/Users/ilg/Library/xPacks/\@xpack-dev-tools/arm-none-eabi-gcc/12.3.1-1.2/.content/
├── README.md
├── arm-none-eabi
│   ├── bin
│   ├── include
...
like `12.3.1-1.2`. The fifth number is the xPack release.
When published as a npm package, the version gets
a sixth number, like `12.3.1-1.2.1`.

Since adherence of third party packages to semver is not guaranteed,
it is recommended to use semver expressions like `^12.3.1` and `~12.3.1`
with caution, and prefer exact matches, like `12.3.1-1.2.1`.
