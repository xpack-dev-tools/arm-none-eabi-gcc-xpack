...
{
  "request": {
    "message": "Test arm-none-eabi-gcc binaries",
      ...
      "jobs": [
        {
          ...
          "script": [
            ...
            "DEBUG=${DEBUG} bash tests/scripts/docker-test.sh ubuntu:12.04 ${base_url} --skip-gdb-py"
          ]
        },
        {
          ...
          "script": [
            ...
            "DEBUG=${DEBUG} bash tests/scripts/docker-test.sh amd64/debian:jessie ${base_url} --skip-gdb-py"
          ]
        },
        {
        ...
        },
        {
          ...
          "script": [
            ...
            "DEBUG=${DEBUG} bash tests/scripts/docker-test.sh --32 i386/debian:jessie ${base_url} --skip-gdb-py"
          ]
        },
        {
        ...
        },
        {
          ...
          "script": [
            ...
            "DEBUG=${DEBUG} bash tests/scripts/docker-test.sh --32 raspbian/jessie ${base_url} --skip-gdb-py"
          ]
        },
        {
        ...
        },
        {
          ...
          "script": [
            "env | sort",
            "pwd",
            "DEBUG=${DEBUG} bash tests/scripts/native-test.sh ${base_url} --skip-gdb-py3" 
          ]
        },
        {
          ...
          "script": [
            "env | sort",
            "pwd",
            "DEBUG=${DEBUG} bash tests/scripts/native-test.sh --32 ${base_url} --skip-gdb-py3" 
          ]
        }
      ],
      "notifications": {
